...
export class ModalComponent implements AfterViewInit, OnDestroy, CanDeactivate<ModalComponent> {
  ...
  canDeactivate(component: ModalComponent, route: ActivatedRouteSnapshot, state: RouterStateSnapshot): any {
